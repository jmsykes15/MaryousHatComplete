...
public class GameRenderer {
	...
	private TextureRegion bg, grass, birdMid, skullUp, skullDown, bar, ready,
			zbLogo, gameOver, googleSignInButton, highScore, scoreboard, star,
			noStar, retry;
	...
	public GameRenderer(GameWorld world, int gameHeight, int midPointY,
			IActivityRequestHandler handler , ActionResolver resolver 
	) {
		myWorld = world;
	...
	private void initAssets() {
		...
		googleSignInButton = AssetLoader.loginButton;
	}
	...
	private void drawSignIn() {
		if (myWorld.isMenu()) {
			batcher.draw(googleSignInButton, 136 / 2 - 25, midPointY + 75,
					googleSignInButton.getRegionWidth() / 1.2f,
					googleSignInButton.getRegionHeight() / 1.2f);
		}else {
			batcher.draw(googleSignInButton, 136 / 2 - 46, midPointY + 8,
					googleSignInButton.getRegionWidth() / 1.2f,
					googleSignInButton.getRegionHeight() / 1.2f);
		}
	}
	...
	public void render(float delta, float runTime) {
		...
		shapeRenderer.setColor(57 / 255.0f, 244 / 255.0f, 246 / 255.0f, 1);
