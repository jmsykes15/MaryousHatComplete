...
import org.lineware.MaryousHat.MHGame;
...
public class SplashScreen implements Screen {
	...
	public SplashScreen(MHGame game, IActivityRequestHandler myHandler, ActionResolver resolver) {
		this.game = game;
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new GameScreen(handler ,resolver));
			}
		};
